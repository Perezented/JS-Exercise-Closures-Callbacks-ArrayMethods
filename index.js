 ...
 */
function processLength(/* CODE HERE */ arrayList, callback) {
    /* CODE HERE */
...
function processSum(/* CODE HERE */ numberList, callback) {
    /* CODE HERE */
    return callback(
        numberList.reduce(function(acccumu, item) {
            return acccumu + item;
        }, 0)
    );
}
...
function getRunnersByTShirtSize(runners, tShirtSize) {
    let shirtArray = runners.filter(function(item) {
...
function tallyUpDonations(runners) {
    let newVar = runners.reduce(function(accumulator, item) {
